            ...
            <form class="w-full max-w-lg" method="GET" action="{{ route('search') }}">
                ...
                <div class="flex flex-wrap -mx-3 mb-6">
                    ...
                    <div class="w-full md:w-1/2 px-3 mb-6 md:mb-0">
                        ...
                        <input class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" id="price_lower_than" name="price_lower_than" value="{{ old('price_lower_than') }}" placeholder="10">
                    </div>
                </div>
